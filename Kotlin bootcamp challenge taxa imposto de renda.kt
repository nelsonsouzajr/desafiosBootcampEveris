...
fun main(args: Array<String>) {
    ...
    when {
        ...
        r in 2000.01..3000.00 -> {
            i = (r - 2000) * 0.08.toFloat()
            println("R$ ${i.format(2)}")
        }
        //18% de Imposto de Renda
        r in 3000.01..4500.00 -> {
            i = (r - 3000) * 0.18.toFloat() + 1000.00.toFloat() * 0.08.toFloat()
            println("R$ ${i.format(2)}")
        }
        //28% de Imposto de Renda
        r > 4500 -> {
           i = ((r - 4500.00) * 0.28.toFloat() + 1500.00.toFloat() * 0.18.toFloat() + 1000.00.toFloat() * 0.08.toFloat()).toFloat()
            println("R$ ${i.format(2)}")
        }
    }
} 
